const stations = [
  ...
  "Ahmedabad", "Pune", "Surat", "Jaipur", "Lucknow", "Kanpur", "Patna",
  "Bhopal", "Indore", "Nagpur", "Vadodara", "Kochi", "Coimbatore", "Madurai",
  "Visakhapatnam", "Bhubaneswar", "Patiala", "Ranchi", "Raipur", "Dehradun",
  "Agra", "Jodhpur", "Thiruvananthapuram", "Guwahati"
];
...
searchBtn.addEventListener("click", () => {
  ...
  fetch("http://127.0.0.1:5000/api/dijkstra", {
    ...
    body: JSON.stringify({ start: from, end: to, mode: "women" })
  })
    .then((res) => res.json())
    .then((data) => {
      ...
      routeControl = L.Routing.control({
        ...
        lineOptions: {
          styles: [{ color: 'deeppink', weight: 6, opacity: 0.9 }]
        },
        createMarker: (i, wp, n) => {
